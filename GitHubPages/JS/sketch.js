...
function preload() {
    hockeyplayers = loadTable('/csvTables/hockeydata.csv', 'header');
    teamColors = loadTable('csvTables/teamColorData.csv', 'header');
    cities = loadTable('/csvTables/cityLatLng.csv', 'header');
}
